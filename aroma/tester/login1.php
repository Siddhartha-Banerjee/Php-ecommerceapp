        ...
        <div class="col-lg-6">
          <div class="login_box_img">
            <div class="hover">
              ...
              <p>Create an account to gain access to all our products.</p>
          ...
          <div class="login_form_inner">
            ...
            <form class="row login_form" action="login.php" id="contactForm" method="POST" >
              <div class="col-md-12 form-group">
                ...
                <input type="text" class="form-control" id="email" name="name" placeholder="Email id." onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email Id'" onkeyup="check(this)" required>
