...
<head>
  ...
  <title>Aroma Shop - Power Banks</title>
  ...
  <main class="site-main">
        ...
        <div class="row no-gutters align-items-center pt-60px">
          ...
          <div class="col-sm-7 col-lg-6 offset-lg-1 pl-4 pl-md-5 pl-lg-0">
            <div class="hero-banner__content">
              ...
              <h5> <p>Choose from our wide range of affordable Power Banks</p></h5>
    ...
    <section class="section-margin calc-60px">
      <div class="container">
        ...
        <div class="row">
          <?php $q=mysqli_query($connection,"SELECT * FROM products WHERE pfile LIKE 'pb%'");
          $count=mysqli_num_rows($q);
          ...
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              <div class="card-product__img">
               <a href="p2.php?id=<?php echo $row[0] ?>"><img class="card-img" src="<?php echo $row[3] ?>" height=250px alt=""></a>
                <ul class="card-product__imgOverlay">
                  <li><a href="p2.php?id=<?php echo $row[0] ?>"><button><i class="ti-search"></i></button></a></li>
                  <li><a href="p2.php?id=<?php echo $row[0] ?>"><button><i class="ti-shopping-cart"></i></button></a></li>
                  <li><a href="p2.php?id=<?php echo $row[0] ?>"><button><i class="ti-heart"></i></button></li>
                </ul>
              </div>
              <div class="card-body">
                 
                <h4 class="card-product__title"><a href="p2.php?id=<?php echo $row[0] ?>"><?php echo $row[1] ?></a></h4>
