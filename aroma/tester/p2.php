		...
		<div class="container">
			<div class="row s_product_inner">
              ...
              <label for="qty">Quantity:</label>
							...
							if (isset($_POST['pname'])) {
								...
								if(mysqli_num_rows($q1)==1)
								{
									?>
									 ...
									 <script type="text/javascript">window.location.href="p2.php?id=<?php echo $proid ?>"</script>
				        ...
				        if($q) { ?>	<script type="text/javascript">window.location.href="p2.php?id=<?php echo $proid ?>"</script>
					<?php }
					 	}
							}
