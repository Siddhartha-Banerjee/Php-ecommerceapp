  ...
  <!--================Single Product Area =================-->
			...
			<div class="row s_product_inner">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<ul class="list">
							<li><a class="active" href="#"><span>Category</span> : Phones</a></li>
              ...
              <label for="qty">Quantity:</label>
              				<form method="POST">
								...
								<input type="text" name="pfile" value="phone" hidden>
							...
							if (isset($_POST['pname'])) {
								...
								if(mysqli_num_rows($q1)==1)
								{
									?>
									 ...
									 <script type="text/javascript">window.location.href="phone1.php?id=<?php echo $proid ?>"</script>
				        ...
				        if($q) { ?>	<script type="text/javascript">window.location.href="phone1.php?id=<?php echo $proid ?>"</script>
					<?php }
					 	}
							}
	...
	<section class="related-product-area section-margin--small mt-0">
        ...
        <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <div class="single-search-product d-flex">
              <a href="phone1.php?id=11"><img src="img/product/product1.png" alt=""></a>
              <div class="desc">
                  <a href="phone1.php?id=11" class="title">iPhoneX</a>
                  <div class="price">Rs 54999.00</div>
              </div>
            </div>
            <div class="single-search-product d-flex">
              <a href="phone1.php?id=25"><img src="img/product/product2.png" alt=""></a>
              <div class="desc">
                <a href="phone1.php?id=25" class="title">JBL Go 2</a>
        ...
        <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <div class="single-search-product d-flex">
              <a href="phone1.php?id=3"><img src="img/product/product3.png" alt=""></a>
              <div class="desc">
                  <a href="phone1.php?id=3" class="title">Redmi Note 8</a>
                  <div class="price">Rs 8999.00</div>
              </div>
            </div>
            <div class="single-search-product d-flex">
              <a href="phone1.php?id=33"><img src="img/product/product4.png" alt=""></a>
              <div class="desc">
                <a href="phone1.php?id=33" class="title">Boat Rockz-234</a>
        ...
        <div class="col-sm-6 col-xl-3 mb-4 mb-xl-0">
          <div class="single-search-product-wrapper">
            <div class="single-search-product d-flex">
              <a href="phone1.php?id=35"><img src="img/product/product5.png" alt=""></a>
              <div class="desc">
                  <a href="phone1.php?id=35" class="title">Mi 20000mah power bank</a>
                  <div class="price">Rs 1249.00</div>
              </div>
            </div>
            <div class="single-search-product d-flex">
              <a href="phone1.php?id=13"><img src="img/product/product6.png" alt=""></a>
              <div class="desc">
                <a href="phone1.php?id=13" class="title">Sandisk 128gb sd card</a>
