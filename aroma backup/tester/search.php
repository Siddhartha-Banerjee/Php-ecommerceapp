        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item"><a class="nav-link" href="contact.php">Contact us/About</a></li>
            </ul>
      ...
      <div class="container">
        ...
        <div class="row">
          <?php
            ...
            { $n=$_POST['product'];
                $q=mysqli_query($connection,"SELECT * FROM products WHERE pname LIKE'$n%'");
              $count=mysqli_num_rows($q);
              ?> <h2><?php if($count!=0) echo $count." Products found." ?></h2>
              <?php
              if ($count>=1) {
          ...
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card text-center card-product">
              <div class="card-product__img">
               <a href="phone1.php?id=<?php echo $row['id'] ?>"><img class="card-img" src="<?php echo $row['ifile'] ?>" height=250px alt=""></a>
                <ul class="card-product__imgOverlay">
                  <li><a href="phone1.php?id=<?php echo $row['id'] ?>"><button><i class="ti-search"></i></button></a></li>
                  <li><a href="phone1.php?id=<?php echo $row['id'] ?>"><button><i class="ti-shopping-cart"></i></button></a></li>
                  <li><button><i class="ti-heart"></i></button></li>
                </ul>
              </div>
              <div class="card-body">
                 
                <h4 class="card-product__title"><a href="phone1.php?id=<?php echo $row['id'] ?>"><?php echo $row['pname'] ?></a></h4>
                <p class="card-product__price">Rs<?php echo $row['price'] ?></p>
              </div>
            </div>
          </div>
          <?php 
